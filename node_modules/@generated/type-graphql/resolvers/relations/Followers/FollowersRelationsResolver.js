...
let FollowersRelationsResolver = class FollowersRelationsResolver {
    async users_followers_artistIdTousers(followers, ctx) {
        return (0, helpers_1.getPrismaFromContext)(ctx).followers.findUnique({
            where: {
                id: followers.id,
            },
        }).users_followers_artistIdTousers({});
    }
...
], FollowersRelationsResolver.prototype, "users_followers_artistIdTousers", null);
tslib_1.__decorate([
    TypeGraphQL.FieldResolver(_type => Users_1.Users, {
        nullable: false
    }),

...
const FindFirstCommentsOrThrowArgs_1 = require("./args/FindFirstCommentsOrThrowArgs");
...
const FindUniqueCommentsOrThrowArgs_1 = require("./args/FindUniqueCommentsOrThrowArgs");
...
let CommentsCrudResolver = class CommentsCrudResolver {
    ...
    async findFirstCommentsOrThrow(ctx, info, args) {
        const { _count } = (0, helpers_1.transformFields)((0, graphql_fields_1.default)(info));
        return (0, helpers_1.getPrismaFromContext)(ctx).comments.findFirstOrThrow({
            ...args,
            ...(_count && (0, helpers_1.transformCountFieldIntoSelectRelationsCount)(_count)),
        });
    }
    ...
    async findUniqueCommentsOrThrow(ctx, info, args) {
        const { _count } = (0, helpers_1.transformFields)((0, graphql_fields_1.default)(info));
        return (0, helpers_1.getPrismaFromContext)(ctx).comments.findUniqueOrThrow({
            ...args,
            ...(_count && (0, helpers_1.transformCountFieldIntoSelectRelationsCount)(_count)),
        });
    }
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, TypeGraphQL.Args()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object, FindFirstCommentsOrThrowArgs_1.FindFirstCommentsOrThrowArgs]),
    tslib_1.__metadata("design:returntype", Promise)
], CommentsCrudResolver.prototype, "findFirstCommentsOrThrow", null);
tslib_1.__decorate([
    TypeGraphQL.Query(_returns => [Comments_1.Comments], {
        nullable: false
    }),
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, TypeGraphQL.Args()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object, FindUniqueCommentsOrThrowArgs_1.FindUniqueCommentsOrThrowArgs]),
    tslib_1.__metadata("design:returntype", Promise)
], CommentsCrudResolver.prototype, "findUniqueCommentsOrThrow", null);
tslib_1.__decorate([

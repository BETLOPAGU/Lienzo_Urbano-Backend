...
export declare class CommentsCrudResolver {
    ...
    findFirstCommentsOrThrow(ctx: any, info: GraphQLResolveInfo, args: FindFirstCommentsOrThrowArgs): Promise<Comments | null>;
    ...
    findUniqueCommentsOrThrow(ctx: any, info: GraphQLResolveInfo, args: FindUniqueCommentsOrThrowArgs): Promise<Comments | null>;

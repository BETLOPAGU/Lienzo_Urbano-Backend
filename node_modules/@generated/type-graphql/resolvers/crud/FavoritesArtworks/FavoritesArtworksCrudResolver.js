...
const CreateFavoritesArtworksArgs_1 = require("./args/CreateFavoritesArtworksArgs");
const CreateManyFavoritesArtworksArgs_1 = require("./args/CreateManyFavoritesArtworksArgs");
const DeleteFavoritesArtworksArgs_1 = require("./args/DeleteFavoritesArtworksArgs");
...
const UpdateFavoritesArtworksArgs_1 = require("./args/UpdateFavoritesArtworksArgs");
const UpdateManyFavoritesArtworksArgs_1 = require("./args/UpdateManyFavoritesArtworksArgs");
const UpsertFavoritesArtworksArgs_1 = require("./args/UpsertFavoritesArtworksArgs");
...
let FavoritesArtworksCrudResolver = class FavoritesArtworksCrudResolver {
    ...
    async createFavoritesArtworks(ctx, info, args) {
        const { _count } = (0, helpers_1.transformFields)((0, graphql_fields_1.default)(info));
    ...
    async deleteFavoritesArtworks(ctx, info, args) {
        const { _count } = (0, helpers_1.transformFields)((0, graphql_fields_1.default)(info));
    ...
    async updateFavoritesArtworks(ctx, info, args) {
        const { _count } = (0, helpers_1.transformFields)((0, graphql_fields_1.default)(info));
    ...
    async upsertFavoritesArtworks(ctx, info, args) {
        const { _count } = (0, helpers_1.transformFields)((0, graphql_fields_1.default)(info));
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, TypeGraphQL.Args()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object, CreateFavoritesArtworksArgs_1.CreateFavoritesArtworksArgs]),
    tslib_1.__metadata("design:returntype", Promise)
], FavoritesArtworksCrudResolver.prototype, "createFavoritesArtworks", null);
tslib_1.__decorate([
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, TypeGraphQL.Args()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object, DeleteFavoritesArtworksArgs_1.DeleteFavoritesArtworksArgs]),
    tslib_1.__metadata("design:returntype", Promise)
], FavoritesArtworksCrudResolver.prototype, "deleteFavoritesArtworks", null);
tslib_1.__decorate([
    TypeGraphQL.Mutation(_returns => FavoritesArtworks_1.FavoritesArtworks, {
        nullable: true
    }),
    ...
    tslib_1.__param(2, TypeGraphQL.Args()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object, UpdateFavoritesArtworksArgs_1.UpdateFavoritesArtworksArgs]),
    tslib_1.__metadata("design:returntype", Promise)
], FavoritesArtworksCrudResolver.prototype, "updateFavoritesArtworks", null);
tslib_1.__decorate([
    TypeGraphQL.Mutation(_returns => AffectedRowsOutput_1.AffectedRowsOutput, {
        nullable: false
    }),
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, TypeGraphQL.Args()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, Object, UpsertFavoritesArtworksArgs_1.UpsertFavoritesArtworksArgs]),
    tslib_1.__metadata("design:returntype", Promise)
], FavoritesArtworksCrudResolver.prototype, "upsertFavoritesArtworks", null);
tslib_1.__decorate([

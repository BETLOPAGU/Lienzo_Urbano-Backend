...
export declare type SupportedQueries = keyof Pick<typeof DMMF.ModelAction, "findUnique" | "findUniqueOrThrow" | "findFirst" | "findFirstOrThrow" | "findMany" | "aggregate" | "groupBy">;

...
const collections_resolver_1 = require("./collections.resolver");
const prisma_service_1 = require("../prisma.service");
let CollectionsModule = class CollectionsModule {
};
CollectionsModule = __decorate([
    (0, common_1.Module)({
        providers: [collections_resolver_1.CollectionsResolver, collections_service_1.CollectionsService, prisma_service_1.PrismaService],

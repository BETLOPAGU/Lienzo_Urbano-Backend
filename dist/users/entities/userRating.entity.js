...
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int, { description: `ID from the qualifier` }),
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
], UserRating.prototype, "qualifierId", void 0);
__decorate([
    (0, graphql_1.Field)(() => graphql_1.Int, { description: `Assigned rating` }),
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
...
//# sourceMappingURL=userRating.entity.js.map